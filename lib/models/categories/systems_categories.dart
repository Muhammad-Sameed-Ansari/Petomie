          ...
          Category(
            ...
            subcategories: [
              Category(
                ...
                icon: Icons.circle,
                imagePath: 'assets/images/systems/digestive_system/lower_tract/anus.webp',
              ),
              Category(
                id: 'large_intestine', 
          ...
          Category(
            ...
            subcategories: [
              ...
              Category(
                ...
                icon: Icons.circle,
                imagePath: 'assets/images/systems/digestive_system/upper_tract/mouth.webp',
              ),
              Category(
                id: 'pharynx', 
                label: _systemIdToLabel('pharynx'), 
                icon: Icons.circle,
                imagePath: 'assets/images/systems/digestive_system/upper_tract/pharynx.webp',
              ),
              Category(
                id: 'salivary_glands', 
              ...
              Category(
                ...
                icon: Icons.circle,
                imagePath: 'assets/images/systems/digestive_system/upper_tract/tongue.webp',
              ),
            ],
          ),
        ],
          ...
          Category(
            ...
            subcategories: [
              ...
              Category(
                ...
                imagePath: 'assets/images/systems/reproductive_system/female/external_genitalia.webp',
              ),
              Category(
                id: 'mammary_glands', 
          ...
          Category(
            ...
            subcategories: [
              ...
              Category(
                ...
                label: _systemIdToLabel('placenta'), 
                icon: Icons.favorite,
                imagePath: 'assets/images/systems/reproductive_system/female/placenta.webp',
              ),
              Category(
                id: 'uterine_tubes', 
                label: _systemIdToLabel('uterine_tubes'), 
  ...
  static List<Category> _getBirdSystemsCategories() {
    return [
      ...
      Category(
        ...
        subcategories: [
          ...
          Category(
            ...
            icon: Icons.scatter_plot,
            imagePath: 'assets/images/systems/endocrine_system/pituitary_gland.webp',
          ),
          Category(
            id: 'thyroid_glands', 
            label: _systemIdToLabel('thyroid_glands'), 
            icon: Icons.scatter_plot,
            imagePath: 'assets/images/systems/endocrine_system/thyroid_glands.webp',
          ),
          Category(
      ...
      Category(
        ...
        subcategories: [
          Category(id: 'bone_marrow', label: _systemIdToLabel('bone_marrow'), icon: Icons.shield),
          Category(id: 'bone_marrow_deep', label: _systemIdToLabel('bone_marrow_deep'), icon: Icons.shield),
          Category(id: 'bursa_fabricius', label: _systemIdToLabel('bursa_fabricius'), icon: Icons.shield),
          Category(id: 'harderian_gland', label: _systemIdToLabel('harderian_gland'), icon: Icons.shield),
          Category(id: 'harderian_gland_deep', label: _systemIdToLabel('harderian_gland_deep'), icon: Icons.shield),
          Category(id: 'liver_immune', label: _systemIdToLabel('liver_immune'), icon: Icons.shield),
          Category(id: 'spleen', label: _systemIdToLabel('spleen'), icon: Icons.shield),
          Category(id: 'spleen_deep', label: _systemIdToLabel('spleen_deep'), icon: Icons.shield),
          Category(id: 'thymus', label: _systemIdToLabel('thymus'), icon: Icons.shield),
          Category(
            id: 'tissues',
            label: _systemIdToLabel('tissues'),
            icon: Icons.layers,
            subcategories: [
              Category(id: 'balt', label: _systemIdToLabel('balt'), icon: Icons.shield),
              Category(id: 'cecal_tonsils', label: _systemIdToLabel('cecal_tonsils'), icon: Icons.shield),
              Category(id: 'galt', label: _systemIdToLabel('galt'), icon: Icons.shield),
              Category(id: 'lymphoid_tissue', label: _systemIdToLabel('lymphoid_tissue'), icon: Icons.shield),
              Category(id: 'peyers_patches', label: _systemIdToLabel('peyers_patches'), icon: Icons.shield),
            ],
          ),
        ],
        ...
        subcategories: [
          ...
          Category(
            ...
            subcategories: [
              ...
              Category(
                id: 'copulatory_organ', 
                label: _systemIdToLabel('copulatory_organ'), 
                icon: Icons.scatter_plot,
                imagePath: 'assets/images/systems/reproductive_system/male/copulatory_organ.webp',
              ),
              Category(
                id: 'epididymis', 
                label: _systemIdToLabel('epididymis'), 
